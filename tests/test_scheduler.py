...
from app.services.scheduler import get_scheduler, get_job_status, shutdown_scheduler
...
def test_scheduler():
    ...
    try:
        ...
        # Do not leak a real scheduler into later readiness tests. Production
        # keeps the scheduler alive in its dedicated process; this test must
        # model its lifecycle explicitly.
        shutdown_scheduler()
