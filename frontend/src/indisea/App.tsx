...
export default function App() {
  ...
  return <div className="indisea-site" data-theme={theme}><HomepageMotion loading={loading} onLoadingComplete={finishLoading} /><div className={`indisea-loader ${loading ? '' : 'is-done'}`} data-loader aria-hidden="true"><div><span data-loader-count>000</span><i>链易配</i></div><b data-loader-progress /></div><CustomCursor /><PublicSiteHeader /><HomePage /><SiteFooter /></div>;
}
